...
int main(void)
{
  ...
  while(1) {
	...
	for (uint8_t var = 4; var > 0; var--) {
		for (uint8_t var2 = 0; var2<50; ++var2) {
		    display_fnd(help[0], (3+var)%4, 5);
		    display_fnd(help[1], (2+var)%4, 5);
		    display_fnd(help[2], (1+var)%4, 5);
		    display_fnd(help[3], (0+var)%4, 5);
		}
